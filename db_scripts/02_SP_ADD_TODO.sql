...
CREATE PROCEDURE `add_todo_for_user_id` (IN local_user_id INT, IN new_todo_id INT, IN data_in VARCHAR(100), IN completed TINYINT)
BEGIN
	...
	ELSE
		...
		VALUES (new_todo_id, data_in, completed, local_user_id);
	END IF;
END//
delimiter ;
